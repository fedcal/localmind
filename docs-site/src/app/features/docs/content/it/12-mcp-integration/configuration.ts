export const content = `# Configurazione MCP in LocalMind
...
> - Precedente: [03-client-implementation.md](/docs/12-mcp-integration/client-implementation)
> - Prossimo: [05-esempi-utilizzo.md](/docs/12-mcp-integration/usage-examples)
