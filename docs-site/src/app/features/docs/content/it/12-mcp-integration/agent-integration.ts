export const content = `# Integrazione MCP con Agenti AI di LocalMind
...
> - Precedente: [05-esempi-utilizzo.md](/docs/12-mcp-integration/usage-examples)
> - Prossimo: [07-troubleshooting.md](/docs/12-mcp-integration/troubleshooting)
