export const content = `# Implementazione MCP Server in LocalMind
...
> - Precedente: [01-panoramica-protocollo-mcp.md](/docs/12-mcp-integration/mcp-protocol-overview)
> - Prossimo: [03-client-implementation.md](/docs/12-mcp-integration/client-implementation)
