export const content = `# Panoramica del Model Context Protocol (MCP)
...
di Spring AI (vedi [02-server-implementation.md](/docs/12-mcp-integration/server-implementation)).
...
> e' previsto nella roadmap (vedi [07-troubleshooting.md](/docs/12-mcp-integration/troubleshooting)).
...
- [02-server-implementation.md](/docs/12-mcp-integration/server-implementation) - LocalMind come MCP Server
- [03-client-implementation.md](/docs/12-mcp-integration/client-implementation) - LocalMind come MCP Client
...
> - Prossimo: [02-server-implementation.md](/docs/12-mcp-integration/server-implementation)
