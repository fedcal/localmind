export const content = `# Implementazione MCP Client in LocalMind
...
> - Precedente: [02-server-implementation.md](/docs/12-mcp-integration/server-implementation)
> - Prossimo: [04-configurazione.md](/docs/12-mcp-integration/configuration)
> - Integrazione agenti: [06-integrazione-agenti.md](/docs/12-mcp-integration/agent-integration)
`;
