export const content = `# Esempi di Utilizzo MCP in LocalMind
...
> - Precedente: [04-configurazione.md](/docs/12-mcp-integration/configuration)
> - Prossimo: [06-integrazione-agenti.md](/docs/12-mcp-integration/agent-integration)
