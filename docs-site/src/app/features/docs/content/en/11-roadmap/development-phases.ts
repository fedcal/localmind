export const content = `# Development Phases
...
> **Hardening Sprint v1.0.0 GA (February 18, 2026)**: Completed hardening sprint with 5 workstreams:
> - **Dark Mode**: Signal-based ThemeService, 40+ CSS variables, sun/moon toggle, color fixes in ~20 components
> - **Chat SSE Streaming**: SseEmitter backend, StreamingLlmClient for Ollama/OpenAI/Anthropic, frontend fetch+ReadableStream
> - **Form Validation**: Template-driven validation on Settings, Folders, MCP Servers, Login, Chat (System Prompt)
> - **Simple/Advanced Mode**: Persistent toggle to hide advanced parameters in chat
> - **Webhooks**: Full CRUD backend+frontend, event triggers (DOCUMENT_INDEXED, CHAT_COMPLETED, etc.)
> - **Tests**: From 1306 to 1443 backend tests (+137), all passing
