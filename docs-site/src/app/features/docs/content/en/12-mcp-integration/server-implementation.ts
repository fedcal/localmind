export const content = `# MCP Server Implementation in LocalMind
...
> - Previous: [01-mcp-protocol-overview.md](/docs/12-mcp-integration/mcp-protocol-overview)
> - Next: [03-client-implementation.md](/docs/12-mcp-integration/client-implementation)
> - Configuration: [04-configuration.md](/docs/12-mcp-integration/configuration)
`;
