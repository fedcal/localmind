export const content = `# MCP Troubleshooting in LocalMind
...
> - Previous: [06-agent-integration.md](/docs/12-mcp-integration/agent-integration)
> - Overview: [01-mcp-protocol-overview.md](/docs/12-mcp-integration/mcp-protocol-overview)
