export const content = `# MCP Configuration in LocalMind
...
> - Previous: [03-client-implementation.md](/docs/12-mcp-integration/client-implementation)
> - Next: [05-usage-examples.md](/docs/12-mcp-integration/usage-examples)
