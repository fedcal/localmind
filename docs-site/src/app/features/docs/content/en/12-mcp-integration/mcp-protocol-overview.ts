export const content = `# Model Context Protocol (MCP) Overview
...
from Spring AI (see [02-server-implementation.md](/docs/12-mcp-integration/server-implementation)).
...
> is planned in the roadmap (see [07-troubleshooting.md](/docs/12-mcp-integration/troubleshooting)).
...
- [02-server-implementation.md](/docs/12-mcp-integration/server-implementation) - LocalMind as MCP Server
- [03-client-implementation.md](/docs/12-mcp-integration/client-implementation) - LocalMind as MCP Client
...
> - Next: [02-server-implementation.md](/docs/12-mcp-integration/server-implementation)
