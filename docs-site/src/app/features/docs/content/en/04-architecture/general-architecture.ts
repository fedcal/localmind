export const content = `# General Architecture
...
- [General Architecture](#general-architecture)
  ...
  - [5. Communication Protocols](#5-communication-protocols)
    ...
    - [5.4 Future Communication](#54-future-communication)
...
Communication for streaming between frontend and backend for chat uses the SSE protocol:

- **Content-Type**: \`text/event-stream\`
- **Use case**: Real-time chat streaming
- **Endpoint**: \`POST /api/v1/chat/stream\`
- **Status**: Implemented
- **Fallback**: in case of error, the system automatically falls back to synchronous mode (\`POST /api/v1/chat\`)

### 5.4 Future Communication
...
> **Note**: for details on starting optional infrastructure services via Docker, see the [Infrastructure and Services](/docs/05-technology-stack/docker-infrastructure) section.
`;
