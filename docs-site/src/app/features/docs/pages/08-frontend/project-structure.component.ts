...
import { content as contentEN } from '../../content/en/08-frontend/project-structure';
import { content as contentIT } from '../../content/it/08-frontend/project-structure';

@Component({
  selector: 'app-doc-project-structure',
  standalone: true,
...
export class ProjectStructureComponent {
  ...
  next: { path: string; label: string } | null = { path: '/docs/08-frontend/routing-lazy-loading', label: 'Routing Lazy Loading' };
}
