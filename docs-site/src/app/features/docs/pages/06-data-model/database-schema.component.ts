...
import { content as contentEN } from '../../content/en/06-data-model/database-schema';
import { content as contentIT } from '../../content/it/06-data-model/database-schema';

@Component({
  selector: 'app-doc-database-schema',
  standalone: true,
...
export class DatabaseSchemaComponent {
  ...
  next: { path: string; label: string } | null = { path: '/docs/06-data-model/jpa-entities', label: 'Jpa Entities' };
}
