...
import { content as contentEN } from '../../content/en/03-functional-analysis/monitoring-dashboard';
import { content as contentIT } from '../../content/it/03-functional-analysis/monitoring-dashboard';

@Component({
  selector: 'app-doc-monitoring-dashboard',
  standalone: true,
...
export class MonitoringDashboardComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/03-functional-analysis/user-interface', label: 'User Interface' };
