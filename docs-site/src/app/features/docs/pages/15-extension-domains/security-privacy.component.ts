...
import { content as contentEN } from '../../content/en/15-extension-domains/security-privacy';
import { content as contentIT } from '../../content/it/15-extension-domains/security-privacy';

@Component({
  selector: 'app-doc-security-privacy',
  standalone: true,
...
export class SecurityPrivacyComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/15-extension-domains/ingestion-connectors', label: 'Ingestion Connectors' };
