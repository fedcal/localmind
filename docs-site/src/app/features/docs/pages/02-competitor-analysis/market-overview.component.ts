...
import { content as contentEN } from '../../content/en/02-competitor-analysis/market-overview';
import { content as contentIT } from '../../content/it/02-competitor-analysis/market-overview';

@Component({
  selector: 'app-doc-market-overview',
  standalone: true,
...
export class MarketOverviewComponent {
  ...
  next: { path: string; label: string } | null = { path: '/docs/02-competitor-analysis/detailed-comparison', label: 'Detailed Comparison' };
}
