...
import { content as contentEN } from '../../content/en/07-api-reference/api-overview';
import { content as contentIT } from '../../content/it/07-api-reference/api-overview';

@Component({
  selector: 'app-doc-api-overview',
  standalone: true,
...
export class ApiOverviewComponent {
  ...
  next: { path: string; label: string } | null = { path: '/docs/07-api-reference/chat-api', label: 'Chat Api' };
}
