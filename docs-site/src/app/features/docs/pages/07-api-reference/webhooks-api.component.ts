...
import { content as contentEN } from '../../content/en/07-api-reference/webhooks-api';
import { content as contentIT } from '../../content/it/07-api-reference/webhooks-api';

@Component({
  selector: 'app-doc-webhooks-api',
  standalone: true,
...
export class WebhooksApiComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/07-api-reference/dashboard-api', label: 'Dashboard Api' };
