...
import { content as contentEN } from '../../content/en/06-security/local-authentication';
import { content as contentIT } from '../../content/it/06-security/local-authentication';

@Component({
  selector: 'app-doc-local-authentication',
  standalone: true,
...
export class LocalAuthenticationComponent {
