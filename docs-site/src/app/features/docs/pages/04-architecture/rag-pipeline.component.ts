...
import { content as contentEN } from '../../content/en/04-architecture/rag-pipeline';
import { content as contentIT } from '../../content/it/04-architecture/rag-pipeline';

@Component({
  selector: 'app-doc-rag-pipeline',
  standalone: true,
...
export class RagPipelineComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/04-architecture/flow-diagrams', label: 'Flow Diagrams' };
