...
import { content as contentEN } from '../../content/en/12-mcp-integration/troubleshooting';
import { content as contentIT } from '../../content/it/12-mcp-integration/troubleshooting';

@Component({
  selector: 'app-doc-troubleshooting',
  standalone: true,
...
export class TroubleshootingComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/12-mcp-integration/agent-integration', label: 'Agent Integration' };
