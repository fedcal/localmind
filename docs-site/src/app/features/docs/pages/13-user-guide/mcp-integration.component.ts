...
import { content as contentEN } from '../../content/en/13-user-guide/mcp-integration';
import { content as contentIT } from '../../content/it/13-user-guide/mcp-integration';

@Component({
  selector: 'app-doc-mcp-integration',
  standalone: true,
...
export class McpIntegrationComponent {
  ...
  prev: { path: string; label: string } | null = { path: '/docs/13-user-guide/provider-settings', label: 'Provider Settings' };
