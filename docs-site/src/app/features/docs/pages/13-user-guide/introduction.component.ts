...
import { content as contentEN } from '../../content/en/13-user-guide/introduction';
import { content as contentIT } from '../../content/it/13-user-guide/introduction';

@Component({
  selector: 'app-doc-introduction',
  standalone: true,
...
export class IntroductionComponent {
  ...
  next: { path: string; label: string } | null = { path: '/docs/13-user-guide/dashboard', label: 'Dashboard' };
}
