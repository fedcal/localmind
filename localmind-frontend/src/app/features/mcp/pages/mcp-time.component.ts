...
@Component({
  ...
  `,
  styles: [`
    h2 { margin: 0 0 1.5rem 0; color: var(--color-text); }
    ...
    .timer-active-indicator {
      ...
      background: var(--color-success-bg); border-radius: 6px;
    ...
    .timesheet-table th {
      background: var(--color-hover-bg); padding: 0.5rem 0.75rem; text-align: left;
      font-weight: 600; color: var(--color-text); border-bottom: 2px solid var(--color-border-light);
      font-size: 0.8rem;
    }
    .timesheet-table td {
      padding: 0.5rem 0.75rem; border-bottom: 1px solid var(--color-skeleton-base); color: var(--color-text-secondary);
    }
    .timesheet-table tbody tr:hover { background: var(--color-hover-bg); }
    .total-row { background: var(--color-msg-user-bg); }
    .total-row td { border-top: 2px solid var(--color-primary); color: var(--color-primary); }
