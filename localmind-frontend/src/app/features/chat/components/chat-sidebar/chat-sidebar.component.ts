...
@Component({
  ...
  styles: [`
    ...
    .conversation-item.active { background: #e3eaf5; border-left: 3px solid #0f3460; }
    ...
    .action-btn.delete:hover { background: #fde; color: #c62828; }
    ...
    .tag-chip.active { background: #e3eaf5; border-color: #0f3460; font-weight: 600; }
    .tag-dot {
      width: 6px;
      height: 6px;
      border-radius: 50%;
    ...
    .search-bar:focus-within { border-color: #0f3460; }
    ...
    .search-clear:hover { background: #eee; color: #666; }
    ...
    .load-more-btn:hover { background: #f0f0f0; border-color: #0f3460; color: #0f3460; }
