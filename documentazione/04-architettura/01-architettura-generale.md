...
- [Architettura Generale](#architettura-generale)
  ...
  - [5. Protocolli di Comunicazione](#5-protocolli-di-comunicazione)
    ...
    - [5.3 Comunicazione Futura](#53-comunicazione-futura)
...
> **Nota**: per i dettagli sull'avvio dei servizi infrastrutturali opzionali tramite Docker, consultare la sezione [Infrastruttura e Servizi](../05-stack-tecnologico/03-infrastruttura-docker.md).
