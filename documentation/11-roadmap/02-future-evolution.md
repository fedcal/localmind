...
|---|---|---|
| Microservices (prep) | Unsustainable monolith complexity | COMPLETED (Feb 2026) - shared-types module, docker-compose, nginx gateway |
| Event-Driven | Need for distributed asynchronous processing | COMPLETED (Feb 2026) - Spring Events + @Async, 6 event types, 4 listeners |
| CQRS | Significant divergence of read/write patterns | COMPLETED (Feb 2026) - separate read models, event-driven sync |
