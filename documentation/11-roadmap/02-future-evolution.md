...
2. [Planned Features Post-v1.0](#2-planned-features-post-v10)
   ...
   - 2.3 [Multi-User with Authentication](#23-multi-user-with-authentication)
   - 2.4 [Plugin System](#24-plugin-system)
   - 2.5 [Mobile Responsive / PWA](#25-mobile-responsive--pwa)
   - 2.6 [API SDK for External Integration](#26-api-sdk-for-external-integration)
   - 2.7 [Multimodal Model Support](#27-multimodal-model-support)
   - 2.8 [Knowledge Graph](#28-knowledge-graph)
   - 2.9 [Local Fine-Tuning](#29-local-fine-tuning)
   - 2.10 [Agent and Workflow Marketplace](#210-agent-and-workflow-marketplace)
   - 2.11 [Configuration Backup and Restore](#211-configuration-backup-and-restore)
   - 2.12 [Conversation Import/Export](#212-conversation-importexport)
   - 2.13 [Multi-Language UI Support](#213-multi-language-ui-support)
   - 2.14 [Advanced Metrics and Analytics](#214-advanced-metrics-and-analytics)
   - 2.15 [Calendar and Email Integration](#215-calendar-and-email-integration)
...
| # | Gap | RICE Score | Priority | Effort |
|---|-----|-----------|----------|--------|
| 1 | **i18n JSON files** - Missing it.json/en.json files | 333 | P0 | 3-5d |
| 2 | **Loading skeleton loaders** - Partial application | 300 | P0 | 2d |
| 3 | **Dark mode toggle** - Not implemented | 267 | P0 | 2-3d |
| 4 | **Frontend form validation** - Incomplete | 210 | P1 | 2-3d |
| 5 | **Chat streaming SSE** - Not implemented | 191 | P1 | 5-7d |
| 6 | **Simple/Advanced mode** - Not implemented | 95 | P1 | 4-5d |

**v1.0.0 GO-LIVE Criteria:**
- All 1306 backend tests pass
- All 19 Playwright test files pass
- Complete IT/EN i18n functional
- Dark/light mode with toggle and localStorage persistence
- Chat streaming SSE for token-by-token responses
...
### 2.3 Multi-User with Authentication

**Target version:** v1.3.0

**Description:** Support for multiple users with JWT/OAuth2 authentication and per-user data isolation.

**Motivation:** In version 1.0, LocalMind is designed for a single user. Multi-user support enables use in family or small team contexts, maintaining the self-hosted principle.

**Detail:**

| Aspect | Implementation |
|---|---|
| **Authentication** | JWT (local) or OAuth2/OIDC (self-hosted Keycloak) |
| **Data isolation** | Each user sees only their own documents and conversations |
| **Roles** | Admin, User, Viewer |
| **User management** | Admin page for creating/editing/deleting users |
| **Quota** | Configurable limits per user (storage, LLM tokens) |
...
### 2.6 API SDK for External Integration
...
### 2.10 Agent and Workflow Marketplace
...
### 2.11 Configuration Backup and Restore
...
### 2.12 Conversation Import/Export
...
### 2.13 Multi-Language UI Support
...
### 2.14 Advanced Metrics and Analytics
...
### 2.15 Calendar and Email Integration
...
| 12 | Conversation Import/Export | v1.1.0 |
| 11 | Backup and Restore | v1.2.0 |
| 3 | Multi-User | v1.3.0 |
...
| # | Feature | Target version |
|---|---|---|
| 2 | Integrated OCR | v1.2.0 |
| 13 | Multi-Language UI | v1.3.0 |
| 14 | Advanced Metrics | v1.4.0 |
...
| Feature | Trigger |
|---|---|
| Microservices | Unsustainable monolith complexity |
| Event-Driven (Kafka) | Need for distributed asynchronous processing |
| CQRS | Significant divergence of read/write patterns |
| Kubernetes | Enterprise adoption with HA requirements |
