...
@Tag(name = "Settings", description = "Configurazione provider LLM / LLM provider configuration")
public class SettingsController {
    ...
    @GetMapping
    @Operation(summary = "Lista provider configurati / List configured providers")
    @ApiResponse(responseCode = "200", description = "Lista provider / Provider list")
    ...
    @PostMapping
    @Operation(summary = "Crea provider LLM / Create LLM provider")
    @ApiResponse(responseCode = "200", description = "Provider creato / Provider created")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Elimina provider / Delete provider")
    @ApiResponse(responseCode = "204", description = "Provider eliminato / Provider deleted")
    ...
    @PostMapping("/{id}/test")
    @Operation(summary = "Testa connessione provider / Test provider connection")
    ...
    @Operation(summary = "Stato Ollama / Ollama status")
    @ApiResponse(responseCode = "200", description = "Stato Ollama / Ollama status")
    ...
    @Operation(summary = "Avvia Ollama / Start Ollama")
    @ApiResponse(responseCode = "200", description = "Ollama avviato / Ollama started")
    ...
    @Operation(summary = "Lista modelli Ollama / List Ollama models")
    ...
    @Operation(summary = "Scarica modello Ollama / Pull Ollama model")
    @ApiResponse(responseCode = "200", description = "Download avviato / Download started")
    @ApiResponse(responseCode = "400", description = "Richiesta non valida / Bad request")
    ...
    @Operation(summary = "Scarica modello Ollama in streaming / Stream pull Ollama model")
    @ApiResponse(responseCode = "200", description = "Stream SSE progresso download / SSE download progress stream")
    ...
    @Operation(summary = "Elimina modello Ollama / Delete Ollama model")
    @ApiResponse(responseCode = "200", description = "Modello eliminato / Model deleted")
    @ApiResponse(responseCode = "404", description = "Non trovato / Not found")
    ...
    @Operation(summary = "Aggiorna modello predefinito / Update default model")
    @ApiResponse(responseCode = "200", description = "Modello predefinito aggiornato / Default model updated")
    @ApiResponse(responseCode = "400", description = "Richiesta non valida / Bad request")
    @ApiResponse(responseCode = "404", description = "Non trovato / Not found")
