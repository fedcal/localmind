...
class MistralStreamingLlmAdapterTest {

    @Mock
    private MistralAiChatModel chatModel;

    private MistralStreamingLlmAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new MistralStreamingLlmAdapter(chatModel);
    }
    ...
    void streamResponse_shouldStreamTokensAndComplete() {
        ...
        ChatResponse chunk2 = buildStreamChunk(" world", 0, 0, 0);
        ChatResponse finalChunk = buildStreamChunk("!", 10, 20, 30);
        ...
        assertThat(receivedTokens).containsExactly("Hello", " world", "!");
    ...
    void streamResponse_shouldCallOnErrorWhenFluxErrors() {
        ...
        assertThat(receivedError.get().getMessage()).isEqualTo("Stream error");
    }
